...
# instance fields
.field private logFile:Lio/fabric/sdk/android/services/common/k;
...
.method private doWriteToLog(JLjava/lang/String;)V
    ...
    .prologue
    .line 114
    iget-object v0, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Lio/fabric/sdk/android/services/common/k;
    ...
    .line 150
    iget-object v1, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Lio/fabric/sdk/android/services/common/k;

    invoke-virtual {v1, v0}, Lio/fabric/sdk/android/services/common/k;->a([B)V

    .line 153
    :goto_2
    iget-object v0, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Lio/fabric/sdk/android/services/common/k;

    invoke-virtual {v0}, Lio/fabric/sdk/android/services/common/k;->b()Z
    ...
    invoke-virtual {v0}, Lio/fabric/sdk/android/services/common/k;->a()I
    ...
    invoke-virtual {v0}, Lio/fabric/sdk/android/services/common/k;->c()V
    :try_end_0
...
.method private openLogFile()V
    ...
    invoke-direct {v0, v1}, Lio/fabric/sdk/android/services/common/k;-><init>(Ljava/io/File;)V

    iput-object v0, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Lio/fabric/sdk/android/services/common/k;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getLogAsByteString()Lcom/crashlytics/android/core/ByteString;
    ...
    invoke-virtual {v0, v3}, Lio/fabric/sdk/android/services/common/k;->a(Lio/fabric/sdk/android/services/common/k$c;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
