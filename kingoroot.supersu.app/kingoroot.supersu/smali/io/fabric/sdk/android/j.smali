...
.super Lio/fabric/sdk/android/f;
...
.method public constructor <init>(Ljava/util/concurrent/Future;Ljava/util/Collection;)V
    ...
    .prologue
    .line 61
    invoke-direct {p0}, Lio/fabric/sdk/android/f;-><init>()V
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/j;->a:Lio/fabric/sdk/android/services/network/c;

    .line 63
    iput-object p1, p0, Lio/fabric/sdk/android/j;->j:Ljava/util/concurrent/Future;

    .line 64
    iput-object p2, p0, Lio/fabric/sdk/android/j;->k:Ljava/util/Collection;
...
.method private a(Lio/fabric/sdk/android/services/settings/n;Ljava/util/Collection;)Lio/fabric/sdk/android/services/settings/d;
    ...
    .prologue
    .line 208
    invoke-virtual {p0}, Lio/fabric/sdk/android/j;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {v1, v0}, Lio/fabric/sdk/android/services/common/d;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 213
    iget-object v0, p0, Lio/fabric/sdk/android/j;->g:Ljava/lang/String;
    ...
    .line 214
    invoke-virtual {p0}, Lio/fabric/sdk/android/j;->getIdManager()Lio/fabric/sdk/android/services/common/IdManager;
    ...
    iget-object v3, p0, Lio/fabric/sdk/android/j;->f:Ljava/lang/String;

    iget-object v4, p0, Lio/fabric/sdk/android/j;->e:Ljava/lang/String;

    iget-object v6, p0, Lio/fabric/sdk/android/j;->h:Ljava/lang/String;

    iget-object v8, p0, Lio/fabric/sdk/android/j;->i:Ljava/lang/String;
...
.method private a(Lio/fabric/sdk/android/services/settings/e;Lio/fabric/sdk/android/services/settings/n;Ljava/util/Collection;)Z
    ...
    .prologue
    .line 202
    invoke-direct {p0, p2, p3}, Lio/fabric/sdk/android/j;->a(Lio/fabric/sdk/android/services/settings/n;Ljava/util/Collection;)Lio/fabric/sdk/android/services/settings/d;
    ...
    invoke-virtual {p0}, Lio/fabric/sdk/android/j;->b()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p1, Lio/fabric/sdk/android/services/settings/e;->c:Ljava/lang/String;

    iget-object v4, p0, Lio/fabric/sdk/android/j;->a:Lio/fabric/sdk/android/services/network/c;

    invoke-direct {v1, p0, v2, v3, v4}, Lio/fabric/sdk/android/services/settings/x;-><init>(Lio/fabric/sdk/android/f;Ljava/lang/String;Ljava/lang/String;Lio/fabric/sdk/android/services/network/c;)V
...
.method private a(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    ...
    .line 157
    invoke-direct {p0, p1, p2, p3}, Lio/fabric/sdk/android/j;->b(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    ...
    invoke-interface {v0, v1, v2, v3}, Lio/fabric/sdk/android/i;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    .line 175
    invoke-direct {p0, p1, p2, p3}, Lio/fabric/sdk/android/j;->c(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
...
.method private b(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    ...
    invoke-direct {p0, v0, p3}, Lio/fabric/sdk/android/j;->a(Lio/fabric/sdk/android/services/settings/n;Ljava/util/Collection;)Lio/fabric/sdk/android/services/settings/d;
    ...
    invoke-direct {v1, p0, v2, v3, v4}, Lio/fabric/sdk/android/services/settings/h;-><init>(Lio/fabric/sdk/android/f;Ljava/lang/String;Ljava/lang/String;Lio/fabric/sdk/android/services/network/c;)V
...
.method private c()Lio/fabric/sdk/android/services/settings/s;
    ...
    iget-object v2, p0, Lio/fabric/sdk/android/j;->idManager:Lio/fabric/sdk/android/services/common/IdManager;

    iget-object v3, p0, Lio/fabric/sdk/android/j;->a:Lio/fabric/sdk/android/services/network/c;

    iget-object v4, p0, Lio/fabric/sdk/android/j;->e:Ljava/lang/String;

    iget-object v5, p0, Lio/fabric/sdk/android/j;->f:Ljava/lang/String;
    ...
    .line 124
    invoke-virtual/range {v0 .. v6}, Lio/fabric/sdk/android/services/settings/q;->a(Lio/fabric/sdk/android/f;Lio/fabric/sdk/android/services/common/IdManager;Lio/fabric/sdk/android/services/network/c;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lio/fabric/sdk/android/services/settings/q;
...
.method private c(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    ...
    invoke-direct {p0, p2, v0, p3}, Lio/fabric/sdk/android/j;->a(Lio/fabric/sdk/android/services/settings/e;Lio/fabric/sdk/android/services/settings/n;Ljava/util/Collection;)Z
...
.method protected a()Ljava/lang/Boolean;
    ...
    .line 99
    invoke-direct {p0}, Lio/fabric/sdk/android/j;->c()Lio/fabric/sdk/android/services/settings/s;
    ...
    .line 104
    :try_start_0
    iget-object v0, p0, Lio/fabric/sdk/android/j;->j:Ljava/util/concurrent/Future;
    ...
    .line 111
    :goto_0
    iget-object v4, p0, Lio/fabric/sdk/android/j;->k:Ljava/util/Collection;

    invoke-virtual {p0, v0, v4}, Lio/fabric/sdk/android/j;->a(Ljava/util/Map;Ljava/util/Collection;)Ljava/util/Map;
    ...
    .line 112
    invoke-direct {p0, v2, v3, v0}, Lio/fabric/sdk/android/j;->a(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {v2, v3, v4, v0}, Lio/fabric/sdk/android/i;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method a(Ljava/util/Map;Ljava/util/Collection;)Ljava/util/Map;
    ...
    new-instance v3, Lio/fabric/sdk/android/h;
    ...
    invoke-direct {v3, v4, v0, v5}, Lio/fabric/sdk/android/h;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method protected synthetic doInBackground()Ljava/lang/Object;
    ...
    .prologue
    .line 45
    invoke-virtual {p0}, Lio/fabric/sdk/android/j;->a()Ljava/lang/Boolean;
...
.method protected onPreExecute()Z
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/j;->g:Ljava/lang/String;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/j;->b:Landroid/content/pm/PackageManager;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/j;->c:Ljava/lang/String;

    .line 78
    iget-object v1, p0, Lio/fabric/sdk/android/j;->b:Landroid/content/pm/PackageManager;

    iget-object v2, p0, Lio/fabric/sdk/android/j;->c:Ljava/lang/String;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/j;->d:Landroid/content/pm/PackageInfo;

    .line 79
    iget-object v1, p0, Lio/fabric/sdk/android/j;->d:Landroid/content/pm/PackageInfo;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/j;->e:Ljava/lang/String;
    ...
    :goto_0
    iput-object v1, p0, Lio/fabric/sdk/android/j;->f:Ljava/lang/String;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/j;->h:Ljava/lang/String;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/j;->i:Ljava/lang/String;
