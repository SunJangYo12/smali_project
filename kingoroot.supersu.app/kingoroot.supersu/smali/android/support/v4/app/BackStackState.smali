...
.method public constructor <init>(Landroid/support/v4/app/l;)V
    ...
    .line 48
    iget-object v1, p1, Landroid/support/v4/app/l;->c:Ljava/util/ArrayList;
    ...
    .line 51
    iget-boolean v1, p1, Landroid/support/v4/app/l;->j:Z
    ...
    .line 57
    iget-object v0, p1, Landroid/support/v4/app/l;->c:Ljava/util/ArrayList;
    ...
    iget v6, v0, Landroid/support/v4/app/l$a;->a:I
    ...
    iget v6, v0, Landroid/support/v4/app/l$a;->d:I
    ...
    iget v6, v0, Landroid/support/v4/app/l$a;->e:I
    ...
    .line 67
    iget-object v0, p1, Landroid/support/v4/app/l;->l:Ljava/lang/String;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    .line 68
    iget v0, p1, Landroid/support/v4/app/l;->n:I
    ...
    .line 70
    iget-object v0, p1, Landroid/support/v4/app/l;->p:Ljava/lang/CharSequence;
    ...
    .line 73
    iget-object v0, p1, Landroid/support/v4/app/l;->s:Ljava/util/ArrayList;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    .line 74
    iget-object v0, p1, Landroid/support/v4/app/l;->t:Ljava/util/ArrayList;
...
.method public a(Landroid/support/v4/app/v;)Landroid/support/v4/app/l;
    ...
    invoke-direct {v3, p1}, Landroid/support/v4/app/l;-><init>(Landroid/support/v4/app/v;)V
    ...
    .line 98
    new-instance v4, Landroid/support/v4/app/l$a;

    invoke-direct {v4}, Landroid/support/v4/app/l$a;-><init>()V
    ...
    iput v0, v4, Landroid/support/v4/app/l$a;->a:I
    ...
    .line 104
    iget-object v5, p1, Landroid/support/v4/app/v;->g:Landroid/util/SparseArray;
    ...
    .line 105
    iput-object v0, v4, Landroid/support/v4/app/l$a;->b:Landroid/support/v4/app/Fragment;
    ...
    iput v0, v4, Landroid/support/v4/app/l$a;->c:I
    ...
    iput v0, v4, Landroid/support/v4/app/l$a;->d:I
    ...
    iput v0, v4, Landroid/support/v4/app/l$a;->e:I
    ...
    iput v0, v4, Landroid/support/v4/app/l$a;->f:I

    .line 113
    iget v0, v4, Landroid/support/v4/app/l$a;->c:I

    iput v0, v3, Landroid/support/v4/app/l;->d:I

    .line 114
    iget v0, v4, Landroid/support/v4/app/l$a;->d:I

    iput v0, v3, Landroid/support/v4/app/l;->e:I

    .line 115
    iget v0, v4, Landroid/support/v4/app/l$a;->e:I

    iput v0, v3, Landroid/support/v4/app/l;->f:I

    .line 116
    iget v0, v4, Landroid/support/v4/app/l$a;->f:I

    iput v0, v3, Landroid/support/v4/app/l;->g:I

    .line 117
    invoke-virtual {v3, v4}, Landroid/support/v4/app/l;->a(Landroid/support/v4/app/l$a;)V
    ...
    iput v0, v3, Landroid/support/v4/app/l;->i:I

    .line 122
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    iput-object v0, v3, Landroid/support/v4/app/l;->l:Ljava/lang/String;

    .line 123
    iget v0, p0, Landroid/support/v4/app/BackStackState;->e:I

    iput v0, v3, Landroid/support/v4/app/l;->n:I

    .line 124
    iput-boolean v7, v3, Landroid/support/v4/app/l;->j:Z

    .line 125
    iget v0, p0, Landroid/support/v4/app/BackStackState;->f:I

    iput v0, v3, Landroid/support/v4/app/l;->o:I

    .line 126
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    iput-object v0, v3, Landroid/support/v4/app/l;->p:Ljava/lang/CharSequence;
    ...
    iput-object v0, v3, Landroid/support/v4/app/l;->r:Ljava/lang/CharSequence;

    .line 129
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/l;->s:Ljava/util/ArrayList;

    .line 130
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->k:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/l;->t:Ljava/util/ArrayList;

    .line 131
    iget-boolean v0, p0, Landroid/support/v4/app/BackStackState;->l:Z

    iput-boolean v0, v3, Landroid/support/v4/app/l;->u:Z

    .line 132
    invoke-virtual {v3, v7}, Landroid/support/v4/app/l;->a(I)V
