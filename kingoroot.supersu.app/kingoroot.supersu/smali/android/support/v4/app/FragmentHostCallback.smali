...
.field private f:Landroid/support/v4/util/i;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method constructor <init>(Landroid/app/Activity;Landroid/content/Context;Landroid/os/Handler;I)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentHostCallback;->d:Landroid/support/v4/app/v;
...
.method a(Ljava/lang/String;ZZ)Landroid/support/v4/app/ab;
    ...
    .prologue
    .line 304
    iget-object v0, p0, Landroid/support/v4/app/FragmentHostCallback;->f:Landroid/support/v4/util/i;
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentHostCallback;->f:Landroid/support/v4/util/i;

    .line 307
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/FragmentHostCallback;->f:Landroid/support/v4/util/i;

    invoke-virtual {v0, p1}, Landroid/support/v4/util/i;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, p0, p2}, Landroid/support/v4/app/ab;-><init>(Ljava/lang/String;Landroid/support/v4/app/FragmentHostCallback;Z)V

    .line 310
    iget-object v1, p0, Landroid/support/v4/app/FragmentHostCallback;->f:Landroid/support/v4/util/i;

    invoke-virtual {v1, p1, v0}, Landroid/support/v4/util/i;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method a(Landroid/support/v4/util/i;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 355
    invoke-virtual {p1, v1}, Landroid/support/v4/util/i;->c(I)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/support/v4/app/ab;

    invoke-virtual {v0, p0}, Landroid/support/v4/app/ab;->a(Landroid/support/v4/app/FragmentHostCallback;)V
    ...
    .line 358
    :cond_0
    iput-object p1, p0, Landroid/support/v4/app/FragmentHostCallback;->f:Landroid/support/v4/util/i;
...
.method a(Z)V
    ...
    .line 258
    iget-object v0, p0, Landroid/support/v4/app/FragmentHostCallback;->h:Landroid/support/v4/app/ab;
...
.method b(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/util/i;->remove(Ljava/lang/Object;)Ljava/lang/Object;
...
.method k()Landroid/support/v4/app/v;
    ...
    .prologue
    .line 206
    iget-object v0, p0, Landroid/support/v4/app/FragmentHostCallback;->d:Landroid/support/v4/app/v;
...
.method m()V
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v4/app/FragmentHostCallback;->a(Ljava/lang/String;ZZ)Landroid/support/v4/app/ab;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/FragmentHostCallback;->h:Landroid/support/v4/app/ab;
...
.method o()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/util/i;->size()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/util/i;->c(I)Ljava/lang/Object;
...
.method p()Landroid/support/v4/util/i;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/util/i;->c(I)Ljava/lang/Object;
    ...
    .line 327
    :cond_0
    invoke-virtual {p0}, Landroid/support/v4/app/FragmentHostCallback;->l()Z
    ...
    .line 340
    iget-object v6, p0, Landroid/support/v4/app/FragmentHostCallback;->f:Landroid/support/v4/util/i;

    iget-object v5, v5, Landroid/support/v4/app/ab;->d:Ljava/lang/String;

    invoke-virtual {v6, v5}, Landroid/support/v4/util/i;->remove(Ljava/lang/Object;)Ljava/lang/Object;
