...
.method public constructor <init>(Landroid/content/res/ColorStateList;F)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ae;->k:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 62
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ae;->b(Landroid/content/res/ColorStateList;)V
...
.method private b(Landroid/content/res/ColorStateList;)V
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/v7/widget/ae;->h:Landroid/content/res/ColorStateList;

    .line 70
    iget-object v0, p0, Landroid/support/v7/widget/ae;->b:Landroid/graphics/Paint;

    iget-object v1, p0, Landroid/support/v7/widget/ae;->h:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Landroid/support/v7/widget/ae;->getState()[I

    move-result-object v2

    iget-object v3, p0, Landroid/support/v7/widget/ae;->h:Landroid/content/res/ColorStateList;
...
.method public c()Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 168
    iget-object v0, p0, Landroid/support/v7/widget/ae;->h:Landroid/content/res/ColorStateList;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 94
    iget-object v0, p0, Landroid/support/v7/widget/ae;->i:Landroid/graphics/PorterDuffColorFilter;
...
.method public isStateful()Z
    ...
    .prologue
    .line 201
    iget-object v0, p0, Landroid/support/v7/widget/ae;->j:Landroid/content/res/ColorStateList;
...
.method protected onStateChange([I)Z
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ae;->h:Landroid/content/res/ColorStateList;
    ...
    .line 190
    iget-object v3, p0, Landroid/support/v7/widget/ae;->b:Landroid/graphics/Paint;

    invoke-virtual {v3, v2}, Landroid/graphics/Paint;->setColor(I)V

    .line 192
    :cond_0
    iget-object v2, p0, Landroid/support/v7/widget/ae;->j:Landroid/content/res/ColorStateList;

    if-eqz v2, :cond_2

    iget-object v2, p0, Landroid/support/v7/widget/ae;->k:Landroid/graphics/PorterDuff$Mode;

    if-eqz v2, :cond_2

    .line 193
    iget-object v1, p0, Landroid/support/v7/widget/ae;->j:Landroid/content/res/ColorStateList;

    iget-object v2, p0, Landroid/support/v7/widget/ae;->k:Landroid/graphics/PorterDuff$Mode;

    invoke-direct {p0, v1, v2}, Landroid/support/v7/widget/ae;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v7/widget/ae;->i:Landroid/graphics/PorterDuffColorFilter;
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    .prologue
    .line 173
    iput-object p1, p0, Landroid/support/v7/widget/ae;->j:Landroid/content/res/ColorStateList;

    .line 174
    iget-object v0, p0, Landroid/support/v7/widget/ae;->j:Landroid/content/res/ColorStateList;

    iget-object v1, p0, Landroid/support/v7/widget/ae;->k:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ae;->i:Landroid/graphics/PorterDuffColorFilter;
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .prologue
    .line 180
    iput-object p1, p0, Landroid/support/v7/widget/ae;->k:Landroid/graphics/PorterDuff$Mode;
