...
.method public a(Z)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/helper/ItemTouchHelper;->a(Landroid/support/v7/widget/RecyclerView$u;I)V
...
.method public a(Landroid/support/v7/widget/RecyclerView;Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, v2, Landroid/support/v7/widget/helper/ItemTouchHelper;->u:Landroid/support/v4/view/d;
    ...
    iget-object v2, v2, Landroid/support/v7/widget/helper/ItemTouchHelper;->b:Landroid/support/v7/widget/RecyclerView$u;
    ...
    invoke-virtual {v2, p2}, Landroid/support/v7/widget/helper/ItemTouchHelper;->b(Landroid/view/MotionEvent;)Landroid/support/v7/widget/helper/ItemTouchHelper$c;
    ...
    iget v5, v2, Landroid/support/v7/widget/helper/ItemTouchHelper$c;->l:F
    ...
    iget v5, v2, Landroid/support/v7/widget/helper/ItemTouchHelper$c;->m:F
    ...
    iget-object v4, v2, Landroid/support/v7/widget/helper/ItemTouchHelper$c;->h:Landroid/support/v7/widget/RecyclerView$u;

    invoke-virtual {v3, v4, v0}, Landroid/support/v7/widget/helper/ItemTouchHelper;->a(Landroid/support/v7/widget/RecyclerView$u;Z)I
    ...
    iget-object v3, v3, Landroid/support/v7/widget/helper/ItemTouchHelper;->l:Landroid/support/v7/widget/helper/ItemTouchHelper$a;
    ...
    iget-object v5, v2, Landroid/support/v7/widget/helper/ItemTouchHelper$c;->h:Landroid/support/v7/widget/RecyclerView$u;

    invoke-virtual {v3, v4, v5}, Landroid/support/v7/widget/helper/ItemTouchHelper$a;->d(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$u;)V
    ...
    iget v2, v2, Landroid/support/v7/widget/helper/ItemTouchHelper$c;->i:I

    invoke-virtual {v3, v4, v2}, Landroid/support/v7/widget/helper/ItemTouchHelper;->a(Landroid/support/v7/widget/RecyclerView$u;I)V
    ...
    invoke-virtual {v2, v3, v1}, Landroid/support/v7/widget/helper/ItemTouchHelper;->a(Landroid/support/v7/widget/RecyclerView$u;I)V
...
.method public b(Landroid/support/v7/widget/RecyclerView;Landroid/view/MotionEvent;)V
    ...
    iget-object v1, v1, Landroid/support/v7/widget/helper/ItemTouchHelper;->u:Landroid/support/v4/view/d;
    ...
    iget-object v3, v3, Landroid/support/v7/widget/helper/ItemTouchHelper;->b:Landroid/support/v7/widget/RecyclerView$u;
    ...
    invoke-virtual {v1, v2, v0}, Landroid/support/v7/widget/helper/ItemTouchHelper;->a(Landroid/support/v7/widget/RecyclerView$u;I)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/helper/ItemTouchHelper;->a(Landroid/support/v7/widget/RecyclerView$u;)V
    ...
    .line 393
    :pswitch_4
    invoke-static {p2}, Landroid/support/v4/view/s;->b(Landroid/view/MotionEvent;)I
