...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/support/transition/TransitionPort$c;
    }
.end annotation
...
.field private c:Landroid/support/transition/aa;
...
.field o:Landroid/support/transition/y;
...
.method public constructor <init>()V
    ...
    .line 72
    iput-object v1, p0, Landroid/support/transition/TransitionPort;->o:Landroid/support/transition/y;
    ...
    iput-object v0, p0, Landroid/support/transition/TransitionPort;->c:Landroid/support/transition/aa;
    ...
    iput-object v0, p0, Landroid/support/transition/TransitionPort;->w:Landroid/support/transition/aa;
...
.method private a(Ljava/util/ArrayList;IZ)Ljava/util/ArrayList;
    ...
    invoke-static {p1, v0}, Landroid/support/transition/TransitionPort$b;->a(Ljava/util/ArrayList;Ljava/lang/Object;)Ljava/util/ArrayList;
    ...
    invoke-static {p1, v0}, Landroid/support/transition/TransitionPort$b;->b(Ljava/util/ArrayList;Ljava/lang/Object;)Ljava/util/ArrayList;
...
.method private a(Ljava/util/ArrayList;Landroid/view/View;Z)Ljava/util/ArrayList;
    ...
    .line 519
    invoke-static {p1, p2}, Landroid/support/transition/TransitionPort$b;->a(Ljava/util/ArrayList;Ljava/lang/Object;)Ljava/util/ArrayList;
    ...
    .line 521
    :cond_1
    invoke-static {p1, p2}, Landroid/support/transition/TransitionPort$b;->b(Ljava/util/ArrayList;Ljava/lang/Object;)Ljava/util/ArrayList;
...
.method private d(Landroid/view/View;Z)V
    ...
    .line 725
    invoke-virtual {p0, v0}, Landroid/support/transition/TransitionPort;->a(Landroid/support/transition/z;)V
    ...
    .line 731
    iget-object v2, p0, Landroid/support/transition/TransitionPort;->c:Landroid/support/transition/aa;

    iget-object v2, v2, Landroid/support/transition/aa;->a:Landroid/support/v4/util/ArrayMap;
    ...
    iget-object v2, v2, Landroid/support/transition/aa;->b:Landroid/util/SparseArray;
    ...
    .line 727
    :cond_a
    invoke-virtual {p0, v0}, Landroid/support/transition/TransitionPort;->b(Landroid/support/transition/z;)V

    goto :goto_3

    .line 736
    :cond_b
    iget-object v5, p0, Landroid/support/transition/TransitionPort;->c:Landroid/support/transition/aa;

    iget-object v5, v5, Landroid/support/transition/aa;->c:Landroid/support/v4/util/e;

    invoke-virtual {v5, v2, v3, v0}, Landroid/support/v4/util/e;->b(JLjava/lang/Object;)V
    ...
    .line 740
    iget-object v2, p0, Landroid/support/transition/TransitionPort;->w:Landroid/support/transition/aa;
    ...
    .line 745
    :cond_d
    iget-object v5, p0, Landroid/support/transition/TransitionPort;->w:Landroid/support/transition/aa;
...
.method public a(Landroid/support/transition/TransitionPort$c;)Landroid/support/transition/TransitionPort;
    .locals 1
...
.method a(Landroid/view/ViewGroup;)V
    ...
    .line 875
    iget-object v6, v1, Landroid/support/transition/TransitionPort$a;->c:Landroid/support/transition/z;

    .line 876
    iget-object v3, v1, Landroid/support/transition/TransitionPort$a;->a:Landroid/view/View;

    .line 877
    iget-object v1, p0, Landroid/support/transition/TransitionPort;->w:Landroid/support/transition/aa;

    iget-object v1, v1, Landroid/support/transition/aa;->a:Landroid/support/v4/util/ArrayMap;
    ...
    iget-object v1, v1, Landroid/support/transition/aa;->b:Landroid/util/SparseArray;
    ...
    .line 886
    iget-object v1, v6, Landroid/support/transition/z;->a:Ljava/util/Map;
    ...
    .line 887
    iget-object v8, v6, Landroid/support/transition/z;->a:Ljava/util/Map;
    ...
    .line 888
    iget-object v9, v3, Landroid/support/transition/z;->a:Ljava/util/Map;
    ...
    .line 919
    :cond_5
    iget-object v0, p0, Landroid/support/transition/TransitionPort;->c:Landroid/support/transition/aa;

    iget-object v1, p0, Landroid/support/transition/TransitionPort;->w:Landroid/support/transition/aa;

    invoke-virtual {p0, p1, v0, v1}, Landroid/support/transition/TransitionPort;->a(Landroid/view/ViewGroup;Landroid/support/transition/aa;Landroid/support/transition/aa;)V
...
.method protected a(Landroid/view/ViewGroup;Landroid/support/transition/aa;Landroid/support/transition/aa;)V
    ...
    iget-object v2, v0, Landroid/support/transition/aa;->a:Landroid/support/v4/util/ArrayMap;

    invoke-direct {v7, v2}, Landroid/support/v4/util/ArrayMap;-><init>(Landroid/support/v4/util/i;)V
    ...
    iget-object v2, v0, Landroid/support/transition/aa;->b:Landroid/util/SparseArray;
    ...
    iget-object v3, v0, Landroid/support/transition/aa;->b:Landroid/util/SparseArray;
    ...
    iget-object v4, v0, Landroid/support/transition/aa;->b:Landroid/util/SparseArray;
    ...
    .line 195
    :cond_0
    new-instance v9, Landroid/support/v4/util/e;

    move-object/from16 v0, p3

    iget-object v2, v0, Landroid/support/transition/aa;->c:Landroid/support/v4/util/e;

    .line 196
    invoke-virtual {v2}, Landroid/support/v4/util/e;->b()I

    move-result v2

    invoke-direct {v9, v2}, Landroid/support/v4/util/e;-><init>(I)V
    ...
    iget-object v3, v0, Landroid/support/transition/aa;->c:Landroid/support/v4/util/e;

    invoke-virtual {v3}, Landroid/support/v4/util/e;->b()I
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/util/e;->b(I)J
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/util/e;->c(I)Ljava/lang/Object;

    move-result-object v3

    invoke-virtual {v9, v4, v5, v3}, Landroid/support/v4/util/e;->b(JLjava/lang/Object;)V
    ...
    iget-object v3, v0, Landroid/support/transition/aa;->a:Landroid/support/v4/util/ArrayMap;
    ...
    invoke-virtual {v2, v14, v15}, Landroid/support/v4/util/e;->a(J)Ljava/lang/Object;
    ...
    .line 242
    invoke-virtual {v9, v14, v15}, Landroid/support/v4/util/e;->c(J)V
    ...
    invoke-virtual {v2, v4}, Landroid/support/v4/util/e;->b(I)J
    ...
    invoke-virtual {v2, v12, v13}, Landroid/support/v4/util/e;->a(J)Ljava/lang/Object;
    ...
    invoke-virtual {v3, v12, v13}, Landroid/support/v4/util/e;->a(J)Ljava/lang/Object;
    ...
    .line 255
    invoke-virtual {v9, v12, v13}, Landroid/support/v4/util/e;->c(J)V
    ...
    .line 282
    :cond_10
    invoke-virtual {v9}, Landroid/support/v4/util/e;->b()I
    ...
    .line 284
    invoke-virtual {v9, v4}, Landroid/support/v4/util/e;->b(I)J
    ...
    invoke-virtual {v2, v6, v7}, Landroid/support/v4/util/e;->a(J)Ljava/lang/Object;
    ...
    .line 287
    invoke-virtual {v9, v6, v7}, Landroid/support/v4/util/e;->a(J)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v3}, Landroid/support/transition/z;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroid/support/transition/TransitionPort;->a(Landroid/view/ViewGroup;Landroid/support/transition/z;Landroid/support/transition/z;)Landroid/animation/Animator;
    ...
    .line 323
    iget-object v7, v3, Landroid/support/transition/z;->b:Landroid/view/View;
    ...
    .line 326
    new-instance v5, Landroid/support/transition/z;

    invoke-direct {v5}, Landroid/support/transition/z;-><init>()V

    .line 327
    iput-object v7, v5, Landroid/support/transition/z;->b:Landroid/view/View;
    ...
    iget-object v14, v2, Landroid/support/transition/z;->a:Ljava/util/Map;
    ...
    .line 339
    iget-object v12, v2, Landroid/support/transition/TransitionPort$a;->c:Landroid/support/transition/z;
    ...
    .line 342
    :cond_16
    iget-object v2, v2, Landroid/support/transition/TransitionPort$a;->c:Landroid/support/transition/z;

    invoke-virtual {v2, v5}, Landroid/support/transition/z;->equals(Ljava/lang/Object;)Z
    ...
    .line 354
    new-instance v5, Landroid/support/transition/TransitionPort$a;
    ...
    .line 355
    invoke-static/range {p1 .. p1}, Landroid/support/transition/ai;->a(Landroid/view/View;)Landroid/support/transition/ai;

    move-result-object v9

    invoke-direct {v5, v3, v7, v9, v2}, Landroid/support/transition/TransitionPort$a;-><init>(Landroid/view/View;Ljava/lang/String;Landroid/support/transition/ai;Landroid/support/transition/z;)V
...
.method a(Landroid/view/ViewGroup;Z)V
    ...
    .line 615
    iput-object v3, v4, Landroid/support/transition/z;->b:Landroid/view/View;

    .line 616
    if-eqz p2, :cond_2

    .line 617
    invoke-virtual {p0, v4}, Landroid/support/transition/TransitionPort;->a(Landroid/support/transition/z;)V
    ...
    iget-object v5, v5, Landroid/support/transition/aa;->a:Landroid/support/v4/util/ArrayMap;
    ...
    .line 624
    iget-object v3, p0, Landroid/support/transition/TransitionPort;->c:Landroid/support/transition/aa;

    iget-object v3, v3, Landroid/support/transition/aa;->b:Landroid/util/SparseArray;
    ...
    .line 619
    :cond_2
    invoke-virtual {p0, v4}, Landroid/support/transition/TransitionPort;->b(Landroid/support/transition/z;)V
    ...
    .line 629
    iget-object v3, p0, Landroid/support/transition/TransitionPort;->w:Landroid/support/transition/aa;
    ...
    .line 640
    iput-object v0, v1, Landroid/support/transition/z;->b:Landroid/view/View;

    .line 641
    if-eqz p2, :cond_6

    .line 642
    invoke-virtual {p0, v1}, Landroid/support/transition/TransitionPort;->a(Landroid/support/transition/z;)V
    ...
    iget-object v3, v3, Landroid/support/transition/aa;->a:Landroid/support/v4/util/ArrayMap;
    ...
    .line 644
    :cond_6
    invoke-virtual {p0, v1}, Landroid/support/transition/TransitionPort;->b(Landroid/support/transition/z;)V
...
.method a(Z)V
    ...
    iget-object v0, v0, Landroid/support/transition/aa;->a:Landroid/support/v4/util/ArrayMap;
    ...
    iget-object v0, v0, Landroid/support/transition/aa;->c:Landroid/support/v4/util/e;
    ...
    .line 670
    :cond_0
    iget-object v0, p0, Landroid/support/transition/TransitionPort;->w:Landroid/support/transition/aa;
...
.method public b(Landroid/support/transition/TransitionPort$c;)Landroid/support/transition/TransitionPort;
    .locals 1
...
.method public c(Landroid/view/View;Z)Landroid/support/transition/z;
    ...
    .prologue
    .line 772
    iget-object v0, p0, Landroid/support/transition/TransitionPort;->o:Landroid/support/transition/y;
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/transition/y;->c(Landroid/view/View;Z)Landroid/support/transition/z;
    ...
    .line 776
    :goto_1
    iget-object v0, v1, Landroid/support/transition/aa;->a:Landroid/support/v4/util/ArrayMap;
    ...
    .line 780
    iget-object v0, v1, Landroid/support/transition/aa;->b:Landroid/util/SparseArray;
    ...
    .line 786
    iget-object v0, v1, Landroid/support/transition/aa;->c:Landroid/support/v4/util/e;

    invoke-virtual {v0, v2, v3}, Landroid/support/v4/util/e;->a(J)Ljava/lang/Object;
...
.method public c(Landroid/view/View;)V
    ...
    .line 806
    invoke-static {p1}, Landroid/support/transition/ai;->a(Landroid/view/View;)Landroid/support/transition/ai;
    ...
    iget-object v0, v0, Landroid/support/transition/TransitionPort$a;->d:Landroid/support/transition/ai;

    invoke-virtual {v3, v0}, Landroid/support/transition/ai;->equals(Ljava/lang/Object;)Z
    ...
    check-cast v1, Landroid/support/transition/TransitionPort$c;

    invoke-interface {v1, p0}, Landroid/support/transition/TransitionPort$c;->b(Landroid/support/transition/TransitionPort;)V
...
.method public d(Landroid/view/View;)V
    ...
    invoke-virtual {v4, v0}, Landroid/support/transition/ai;->equals(Ljava/lang/Object;)Z
    ...
    invoke-interface {v1, p0}, Landroid/support/transition/TransitionPort$c;->c(Landroid/support/transition/TransitionPort;)V
...
.method protected h()V
    ...
    invoke-interface {v1, p0}, Landroid/support/transition/TransitionPort$c;->d(Landroid/support/transition/TransitionPort;)V
...
.method protected i()V
    ...
    invoke-interface {v1, p0}, Landroid/support/transition/TransitionPort$c;->a(Landroid/support/transition/TransitionPort;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/util/e;->c(I)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/util/e;->c(I)Ljava/lang/Object;
...
.method public j()Landroid/support/transition/TransitionPort;
    ...
    iput-object v1, v0, Landroid/support/transition/TransitionPort;->c:Landroid/support/transition/aa;
    ...
    iput-object v1, v0, Landroid/support/transition/TransitionPort;->w:Landroid/support/transition/aa;
    :try_end_1
