...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/support/transition/p$b;
    }
.end annotation
...
.field private c:Landroid/support/transition/p$a;
...
.method static a(Landroid/transition/TransitionValues;)Landroid/support/transition/z;
    .locals 1
    ...
    .line 86
    invoke-static {p0, v0}, Landroid/support/transition/p;->a(Landroid/transition/TransitionValues;Landroid/support/transition/z;)V

    goto :goto_0
.end method

.method static a(Landroid/support/transition/n;Landroid/transition/TransitionValues;)V
    .locals 1
    ...
    .line 68
    invoke-interface {p0, v0}, Landroid/support/transition/n;->captureStartValues(Landroid/support/transition/z;)V

    .line 69
    invoke-static {v0, p1}, Landroid/support/transition/p;->a(Landroid/support/transition/z;Landroid/transition/TransitionValues;)V

    .line 70
    return-void
.end method

.method static a(Landroid/support/transition/z;Landroid/transition/TransitionValues;)V
    .locals 2
...
.method static a(Landroid/transition/TransitionValues;Landroid/support/transition/z;)V
    .locals 2
    ...
    iput-object v0, p1, Landroid/support/transition/z;->b:Landroid/view/View;
...
.method static b(Landroid/support/transition/n;Landroid/transition/TransitionValues;)V
    .locals 1
    ...
    .line 77
    invoke-interface {p0, v0}, Landroid/support/transition/n;->captureEndValues(Landroid/support/transition/z;)V
...
.method static d(Landroid/support/transition/z;)Landroid/transition/TransitionValues;
    .locals 1
    ...
    .line 96
    invoke-static {p0, v0}, Landroid/support/transition/p;->a(Landroid/support/transition/z;Landroid/transition/TransitionValues;)V
...
.method public a()J
    ...
    .prologue
    .line 221
    iget-object v0, p0, Landroid/support/transition/p;->a:Landroid/transition/Transition;
...
.method public a(Landroid/view/ViewGroup;Landroid/support/transition/z;Landroid/support/transition/z;)Landroid/animation/Animator;
    ...
    .line 170
    invoke-static {p2, v1}, Landroid/support/transition/p;->a(Landroid/support/transition/z;Landroid/transition/TransitionValues;)V
    ...
    .line 176
    invoke-static {p3, v0}, Landroid/support/transition/p;->a(Landroid/support/transition/z;Landroid/transition/TransitionValues;)V

    .line 180
    :cond_0
    iget-object v2, p0, Landroid/support/transition/p;->a:Landroid/transition/Transition;
...
.method public a(I)Landroid/support/transition/m;
    ...
    .line 290
    invoke-virtual {p0}, Landroid/support/transition/p;->e()Ljava/util/List;
...
.method public a(Landroid/support/transition/o;)Landroid/support/transition/m;
    ...
    .prologue
    .line 112
    iget-object v0, p0, Landroid/support/transition/p;->c:Landroid/support/transition/p$a;

    if-nez v0, :cond_0

    .line 113
    new-instance v0, Landroid/support/transition/p$a;

    invoke-direct {v0, p0}, Landroid/support/transition/p$a;-><init>(Landroid/support/transition/p;)V

    iput-object v0, p0, Landroid/support/transition/p;->c:Landroid/support/transition/p$a;

    .line 114
    iget-object v0, p0, Landroid/support/transition/p;->a:Landroid/transition/Transition;

    iget-object v1, p0, Landroid/support/transition/p;->c:Landroid/support/transition/p$a;
    ...
    invoke-virtual {v0, p1}, Landroid/support/transition/p$a;->a(Landroid/support/transition/o;)V
...
.method public a(Landroid/support/transition/n;Ljava/lang/Object;)V
    ...
    .prologue
    .line 102
    iput-object p1, p0, Landroid/support/transition/p;->b:Landroid/support/transition/n;

    .line 103
    if-nez p2, :cond_0

    .line 104
    new-instance v0, Landroid/support/transition/p$b;

    invoke-direct {v0, p1}, Landroid/support/transition/p$b;-><init>(Landroid/support/transition/n;)V

    iput-object v0, p0, Landroid/support/transition/p;->a:Landroid/transition/Transition;
    ...
    iput-object p2, p0, Landroid/support/transition/p;->a:Landroid/transition/Transition;
...
.method public b(Landroid/support/transition/o;)Landroid/support/transition/m;
    ...
    invoke-virtual {v0, p1}, Landroid/support/transition/p$a;->b(Landroid/support/transition/o;)V

    .line 126
    iget-object v0, p0, Landroid/support/transition/p;->c:Landroid/support/transition/p$a;

    invoke-virtual {v0}, Landroid/support/transition/p$a;->a()Z
...
.method public b(Landroid/support/transition/z;)V
    ...
    .line 149
    invoke-static {p1, v0}, Landroid/support/transition/p;->a(Landroid/support/transition/z;Landroid/transition/TransitionValues;)V

    .line 150
    iget-object v1, p0, Landroid/support/transition/p;->a:Landroid/transition/Transition;

    invoke-virtual {v1, v0}, Landroid/transition/Transition;->captureEndValues(Landroid/transition/TransitionValues;)V

    .line 151
    invoke-static {v0, p1}, Landroid/support/transition/p;->a(Landroid/transition/TransitionValues;Landroid/support/transition/z;)V
...
.method public c(Landroid/view/View;Z)Landroid/support/transition/z;
    ...
    invoke-static {v1, v0}, Landroid/support/transition/p;->a(Landroid/transition/TransitionValues;Landroid/support/transition/z;)V
