...
.method public constructor <init>(Landroid/support/transition/n;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/transition/f;->a(Landroid/support/transition/n;Ljava/lang/Object;)V
...
.method public a(Landroid/view/ViewGroup;Landroid/support/transition/z;ILandroid/support/transition/z;I)Landroid/animation/Animator;
    ...
    .prologue
    .line 45
    iget-object v0, p0, Landroid/support/transition/f;->a:Landroid/transition/Transition;

    check-cast v0, Landroid/transition/Fade;

    .line 46
    invoke-static {p2}, Landroid/support/transition/f;->d(Landroid/support/transition/z;)Landroid/transition/TransitionValues;

    move-result-object v2

    .line 47
    invoke-static {p4}, Landroid/support/transition/f;->d(Landroid/support/transition/z;)Landroid/transition/TransitionValues;
...
.method public a(Landroid/support/transition/z;)Z
    ...
    invoke-static {p1}, Landroid/support/transition/f;->d(Landroid/support/transition/z;)Landroid/transition/TransitionValues;
