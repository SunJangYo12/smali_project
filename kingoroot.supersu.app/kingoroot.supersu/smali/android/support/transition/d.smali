...
.field private static x:Landroid/support/transition/i;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/transition/d;->w:[Ljava/lang/String;
    ...
    sput-object v0, Landroid/support/transition/d;->x:Landroid/support/transition/i;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/transition/d;->a:[I

    .line 67
    iput-boolean v1, p0, Landroid/support/transition/d;->b:Z

    .line 69
    iput-boolean v1, p0, Landroid/support/transition/d;->c:Z

    return-void
.end method

.method private c(Landroid/support/transition/z;)V
    .locals 7
    ...
    iget-object v1, p0, Landroid/support/transition/d;->a:[I
    ...
    iget-object v2, p0, Landroid/support/transition/d;->a:[I
...
.method public a(Landroid/view/ViewGroup;Landroid/support/transition/z;Landroid/support/transition/z;)Landroid/animation/Animator;
    ...
    iget-object v4, v0, Landroid/support/transition/z;->b:Landroid/view/View;
    ...
    iget-boolean v3, v0, Landroid/support/transition/d;->c:Z
    ...
    iget-boolean v3, v0, Landroid/support/transition/d;->b:Z
    ...
    .line 198
    new-instance v2, Landroid/support/transition/d$1;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Landroid/support/transition/d$1;-><init>(Landroid/support/transition/d;)V

    .line 224
    move-object/from16 v0, p0

    invoke-virtual {v0, v2}, Landroid/support/transition/d;->a(Landroid/support/transition/TransitionPort$c;)Landroid/support/transition/TransitionPort;
    ...
    .line 278
    new-instance v2, Landroid/support/transition/d$2;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Landroid/support/transition/d$2;-><init>(Landroid/support/transition/d;)V
    ...
    .line 306
    :cond_1d
    new-instance v2, Landroid/support/transition/d$3;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Landroid/support/transition/d$3;-><init>(Landroid/support/transition/d;)V
    ...
    iget-object v7, v0, Landroid/support/transition/d;->a:[I
    ...
    .line 329
    invoke-static/range {p1 .. p1}, Landroid/support/transition/ac;->d(Landroid/view/View;)Landroid/support/transition/ac;

    move-result-object v7

    invoke-virtual {v7, v8}, Landroid/support/transition/ac;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v9, v0, Landroid/support/transition/d;->a:[I
    ...
    iget-object v10, v0, Landroid/support/transition/d;->a:[I
    ...
    iget-object v11, v0, Landroid/support/transition/d;->a:[I
    ...
    iget-object v5, v0, Landroid/support/transition/d;->a:[I
    ...
    sget-object v5, Landroid/support/transition/d;->x:Landroid/support/transition/i;
    ...
    .line 339
    new-instance v3, Landroid/support/transition/d$4;

    move-object/from16 v0, p0

    move-object/from16 v1, p1

    invoke-direct {v3, v0, v1, v8, v4}, Landroid/support/transition/d$4;-><init>(Landroid/support/transition/d;Landroid/view/ViewGroup;Landroid/graphics/drawable/BitmapDrawable;Landroid/view/View;)V
...
.method public a(Landroid/support/transition/z;)V
    ...
    .prologue
    .line 106
    invoke-direct {p0, p1}, Landroid/support/transition/d;->c(Landroid/support/transition/z;)V
...
.method public a()[Ljava/lang/String;
    ...
    .prologue
    .line 73
    sget-object v0, Landroid/support/transition/d;->w:[Ljava/lang/String;
