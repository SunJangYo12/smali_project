.class public Landroid/support/graphics/drawable/g$b;
...
.method constructor <init>(C[F)V
    ...
    .line 303
    iput-char p1, p0, Landroid/support/graphics/drawable/g$b;->a:C

    .line 304
    iput-object p2, p0, Landroid/support/graphics/drawable/g$b;->b:[F

    .line 305
    return-void
.end method

.method constructor <init>(Landroid/support/graphics/drawable/g$b;)V
    .locals 3
    ...
    .line 308
    iget-char v0, p1, Landroid/support/graphics/drawable/g$b;->a:C

    iput-char v0, p0, Landroid/support/graphics/drawable/g$b;->a:C

    .line 309
    iget-object v0, p1, Landroid/support/graphics/drawable/g$b;->b:[F

    const/4 v1, 0x0

    iget-object v2, p1, Landroid/support/graphics/drawable/g$b;->b:[F

    array-length v2, v2

    invoke-static {v0, v1, v2}, Landroid/support/graphics/drawable/g;->a([FII)[F

    move-result-object v0

    iput-object v0, p0, Landroid/support/graphics/drawable/g$b;->b:[F
...
.method private static a(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    invoke-static/range {v2 .. v11}, Landroid/support/graphics/drawable/g$b;->a(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    invoke-static/range {v3 .. v21}, Landroid/support/graphics/drawable/g$b;->a(Landroid/graphics/Path;DDDDDDDDD)V
...
.method private static a(Landroid/graphics/Path;[FCC[F)V
    ...
    invoke-static/range {v3 .. v12}, Landroid/support/graphics/drawable/g$b;->a(Landroid/graphics/Path;FFFFFFFZZ)V
...
.method public static a([Landroid/support/graphics/drawable/g$b;Landroid/graphics/Path;)V
    .locals 5
    ...
    invoke-static {p1, v2, v1, v3, v4}, Landroid/support/graphics/drawable/g$b;->a(Landroid/graphics/Path;[FCC[F)V

    .line 323
    aget-object v1, p0, v0

    iget-char v1, v1, Landroid/support/graphics/drawable/g$b;->a:C
...
# virtual methods
.method public a(Landroid/support/graphics/drawable/g$b;Landroid/support/graphics/drawable/g$b;F)V
    .locals 4
    ...
    :goto_0
    iget-object v1, p1, Landroid/support/graphics/drawable/g$b;->b:[F
    ...
    .line 339
    iget-object v1, p0, Landroid/support/graphics/drawable/g$b;->b:[F
    ...
    iget-object v3, p2, Landroid/support/graphics/drawable/g$b;->b:[F
